...
\begin{document}
\title{The \texttt{fontawesome7} Package\thanks{This document corresponds to fontawesome7 version 7.0.1-1, dated 2025/09/16.}}
...
This package provides \LaTeX{} support for Font Awesome 7 icons.
...
To use Font Awesome 7 icons in your document, load the package with:
\begin{verbatim}
  \usepackage{fontawesome7}
\end{verbatim}
Optionally, you can add the |fixed| option to enable fixed-width icons:
\begin{verbatim}
  \usepackage[fixed]{fontawesome7}
\end{verbatim}
...
\textbf{Since the maintainer does not have access to FA Pro, the following features might all be broken!}

Font Awesome 7 is available in both Free and Pro versions. By default, this package uses the Free version. If you have a Pro license and have installed the Font Awesome 7 Pro desktop fonts in your system font path, you can enable Pro support by loading the package with the |[pro]| option:
\begin{verbatim}
  \usepackage[pro]{fontawesome7}
\end{verbatim}
...
\subsection*{Updates}
This package corresponds to Font Awesome 7.0.0.\\
If a newer version is available on the Font Awesome website, check for updates at \url{https://ctan.org/pkg/fontawesome7}. If the latest version is not yet on CTAN, you may contact \href{mailto:tex@2krueger.de}{\nolinkurl{tex@2krueger.de}}.
